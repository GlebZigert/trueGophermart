...
func (suite *TestRegSuite) TestHandler() {
	...
	suite.Run("Register", func() {
		...
		// делаем запрос на регистрацию c нормальной посылкой - должен быть ответ со статусом 200 и валидным ключем авторизации с Uid в хедере
		suite.T().Logf("запрос на регистрацию c нормальной посылкой -  ответ со статусом 200 и валидным ключем авторизации с Uid в хедере")
